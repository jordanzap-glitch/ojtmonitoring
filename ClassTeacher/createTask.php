                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="Task_Code" value="<?php echo $row['Task_Code'];?>" id="exampleInputFirstName">
                        </div>

                         <div class="col-xl-6">
                            <label class="form-control-label">Task Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="Task_Name" value="<?php echo $row['Task_Name'];?>" id="exampleInputFirstName">
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                      ...
                      <input type="text" class="form-control" name="Description" value="<?php echo $row['Description'];?>" id="exampleInputFirstName">
                        </div>

                        <div class="col-xl-6">
                        <label class="form-control-label">Select Date of Deadline<span class="text-danger ml-2">*</span></label>
                        <input type="date" class="form-control" name="Deadline" value="<?php echo $row['Deadline'];?>" id="exampleInputFirstName" min="<?= date('Y-m-d'); ?>">
