        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">All Intern in Class</li>
            </ol>
          </div>
            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Intern in (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>)</h6>
                  <h6 class="m-0 font-weight-bold text-danger">Note: <i>Click on the checkboxes besides each intern to take attendance!</i></h6>
                </div>
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblstudents.admissionNumber,tblstudents.firstName, 
                      tblstudents.lastName,tblstudents.contact, tblstudents.email,tblstudents.address,tblstudents.dateCreated
                      FROM tblstudents 
