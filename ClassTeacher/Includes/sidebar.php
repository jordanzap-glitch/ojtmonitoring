       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Student Trainee</h6>
            <a class="collapse-item" href="viewStudents.php">View List</a>
      ...
      Task
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon4" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Task</h6>
            <a class="collapse-item" href="createTask.php">Task Entry</a>
            <a class="collapse-item" href="download.php">Task Submitted</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewAttendance.php">View All Attendance</a>
            <a class="collapse-item" href="viewStudentAttendance.php">View Intern Attendance</a>
