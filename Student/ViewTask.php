       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Task Submission</h1>
            <ol class="breadcrumb">
              ...
              <div class="card mb-4">
                ...
                <form  action="upload.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" name="Student_ID" value="<?php echo $row['Student_ID'];?>" id="exampleInputFirstName">
                        </div>
                    </div>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                    <?php
                      $query = "SELECT * FROM tbltask where Stat = 'Pending'";
                      $rs = $conn->query($query);
                      $num = $rs->num_rows;
                      $sn=0;
                      if($num > 0)
                        ...
                        while ($rows = $rs->fetch_assoc())
                          {
                            ...
                            echo"
                              <tr>
                                ...
                                <td><a href='?action=edit&Id=".$rows['Id']."'><i class='fas fa-fw fa-edit'></i>COMPLY</a></td>
                              </tr>";
                          }
                      }
                      else
