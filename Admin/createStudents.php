...
if(isset($_POST['save'])){
  ...
  $usernew = "Student";
    ...
    $query=mysqli_query($conn,"insert into tblstudents(admissionNumber,firstName,lastName,classId,classArmId,contact,email,address,password,dateCreated) 
    value('$admissionNumber','$firstName','$lastName','$classId','$classArmId','$contact','$email','$address','$sampPass_2','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set admissionNumber='$admissionNumber', firstName='$firstName', lastName='$lastName', classId='$classId',classArmId='$classArmId',
    contact='$contact', email='$email', address='$address', password='$sampPass_2' where Id='$Id'");

    $query1=mysqli_query($conn,"update tbluser set password='$sampPass_2'
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form method="post">
                   ...
                   <input type="text" class="form-control" name="admissionNumber" value="<?php echo $row['admissionNumber'];?>" id="exampleInputFirstName" >
                   </div>
                   ...
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" name="contact" value="<?php echo $row['contact'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" name="address" value="<?php echo $row['address'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
    ...
    >
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      $query = "SELECT tblstudents.Id,tblclass.className,tblclassarms.classArmName,tblclassarms.Id 
                      AS classArmId,tblstudents.admissionNumber, tblstudents.firstName,tblstudents.lastName,tblstudents.contact,tblstudents.email, 
                      tblstudents.address,tblstudents.password, tblstudents.dateCreated FROM tblstudents 
