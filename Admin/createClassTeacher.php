...
if(isset($_POST['save'])){
  ...
  $usernew = "Coordinator";
    ...
    $query1=mysqli_query($conn,"select * from tbluser where emailAddress ='$emailAddress'");
   ...
   // $sampPass_2 = md5($sampPass);
    ...
    value('$emailAddress','$sampPass_2','$usernew')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    emailAddress='$emailAddress', password='$sampPass_2',phoneNo='$phoneNo', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['classArmId']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query1 = mysqli_query($conn,"DELETE FROM tbluser WHERE emailAddress='$emailAddress'");
        if ($query == TRUE) {
...
<body id="page-top">
  <div id="wrapper">
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Coordinator Entry</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Coordinator Entry</li>
            </ol>
          </div>
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Select Handled Course<span class="text-danger ml-2">*</span></label>
                         <?php
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Handled Section<span class="text-danger ml-2">*</span></label>
                            <?php
    ...
    >
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Coordinator List</h6>
                </div>
