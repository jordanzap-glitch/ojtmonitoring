                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="table-responsive p-3">
                                            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $query = "SELECT tblstudents.Id, tblclass.className, tblclassarms.classArmName, tblstudents.admissionNumber, tblstudents.firstName, tblstudents.lastName, tblstudents.contact, tblstudents.email, tblstudents.address, tblstudents.dateCreated, tblstudents.comp_name FROM tblstudents 
