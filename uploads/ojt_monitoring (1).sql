...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2025 at 01:56 AM
...
CREATE TABLE `tbladmin` (
  ...
  `user_type` varchar(255) NOT NULL DEFAULT 'Administrator'
...
INSERT INTO `tbladmin` (`Id`, `firstName`, `lastName`, `emailAddress`, `password`, `user_type`) VALUES
(1, 'Admin', '', 'src@gmail.com', '12345678', 'Administrator');
...
(18, 'jordan', 'zapanta', 'Jordan@gmail.comn', 'Jordskie@0949', '123', '7', '8', '2025-01-27');
...
(9, 'Jordan@gmail.comn', 'Jordskie@0949', 'Coordinator');
